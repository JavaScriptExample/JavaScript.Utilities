...
<head>
    ...
    <script src="zTreeUtils.js"></script>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <input id="Button3" type="button" value="updateIcon" onclick="updateIcon()" /><br />
            <input id="Button7" type="button" value="updateFont" onclick="updateFont()" /><br />
            <input id="Button4" type="button" value="restoreFont" onclick="restoreFont()" /><br />
            <input id="Button5" type="button" value="addMenuByNode" onclick="addMenuByNodeDemo()" /><br />
